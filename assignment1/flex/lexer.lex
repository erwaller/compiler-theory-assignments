...
{strlit}        {return(STRING);}
                ...
                /* Numbers */
{decfloat}[fF]  {yylval.type = f; install_num(); return(NUMBER);}
{decfloat}[lL]  {yylval.type = ld; install_num(); return(NUMBER);}
{decfloat}      {yylval.type = d; install_num(); return(NUMBER);}
{hexfloat}[fF]  {yylval.type = f; install_num(); return(NUMBER);}
{hexfloat}[lL]  {yylval.type = ld; install_num(); return(NUMBER);}
{hexfloat}      {yylval.type = d; install_num(); return(NUMBER);}

{int}({unsigned}{longlong}|{longlong}{unsigned})    {yylval.type = ull; install_num(); return(NUMBER);}
{int}({unsigned}{long}|{long}{unsigned})            {yylval.type = ul; install_num(); return(NUMBER);}
{int}{unsigned}                                     {yylval.type = u; install_num(); return(NUMBER);}
{int}{longlong}                                     {yylval.type = ll; install_num(); return(NUMBER);}
{int}{long}                                         {yylval.type = l; install_num(); return(NUMBER);}
{int}                                               {yylval.type = i; install_num(); return(NUMBER);}
